                ...
                <div className="container mx-auto px-4 py-2 md:py-1 flex items-center justify-between ml-1">
                    ...
                    <ul className="navbar-nav hidden md:flex space-x-8 ml-12">
                        <li className="nav-item me-3">
                            <a className="nav-link text-negro-claro hover:text-azul-dark-800 text-lg" href="#Inicio">Home</a>
                        </li>
                        <li className="nav-item me-3">
                            <a className="nav-link text-negro-claro hover:text-azul-dark-800 underline-offset-auto text-lg" href="#About">About us</a>
                        </li>
                        <li className="nav-item me-3">
                            <a className="nav-link text-negro-claro over:text-azul-dark-800" href="#Projects">Projects</a>
                        </li>
                        <li className="nav-item me-3">
                        <a className="nav-link text-negro-claro over:text-azuk-darl-800 hover:underline" href="#Contact">Contact</a>
                        </li>
                    </ul>
