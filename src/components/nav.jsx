        ...
        <NavContainer>
          <div className="fixed inset-0 flex items-center justify-center">
            <div className={`links ${isMenuOpen ? 'active' : ''}`}>
              <Link className="mb-12" onClick={toggleMenu} to="/you-ilab/">
                Home
              </Link>
              <Link className="mb-12" onClick={toggleMenu} to="/you-ilab/about">
                About
              </Link>
              <Link className="mb-12" onClick={toggleMenu} to="/you-ilab/projects">
                Projects
              </Link>
              <Link className="mb-12" onClick={toggleMenu} to="/you-ilab/contact">
                Contact
              </Link>
            </div>
